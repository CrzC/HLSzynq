...
#
# P1_RTL.tcl: Tcl script for re-creating project 'P1_RTL'
#
# Generated by Vivado on Mon Aug 30 13:52:40 -0500 2021
...
#
# 1. This project restoration tcl script (P1_RTL.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Documentos/PVivado/P1_RTL/P1_RTL.srcs/sources_1/new/compuertas.vhd"
#    "D:/Documentos/PVivado/P1_RTL/P1_RTL.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#    "D:/Documentos/PVivado/P1_RTL/P1_RTL.srcs/constrs_1/new/constraintsP1.xdc"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../PVivado/P1_RTL"]"
...
set files [list \
 [file normalize "hdl/compuertas.vhd" ]\
...
set file "[file normalize "constraints/constraintsP1.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/constraintsP1.xdc"
...
if { [get_files compuertas.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/compuertas.vhd
}
...
# gates_mux
  ...
  # Create instance: gates_mux_0, and set properties
  set block_name gates_mux
  set block_cell_name gates_mux_0
  if { [catch {set gates_mux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gates_mux_0 eq "" } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports a] [get_bd_pins gates_mux_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins gates_mux_0/sel]
  connect_bd_net -net b_0_1 [get_bd_ports b] [get_bd_pins gates_mux_0/b]
  connect_bd_net -net gates_mux_0_c [get_bd_ports c] [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins gates_mux_0/c]
