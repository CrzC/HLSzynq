...
proc create_root_design { parentCell } {
  ...
  set s_axi_BUS_A [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_BUS_A ]
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv crzc:hls:suma:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net s_axi_BUS_A_0_1 [get_bd_intf_ports s_axi_BUS_A] [get_bd_intf_pins hls_inst/s_axi_BUS_A]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces s_axi_BUS_A] [get_bd_addr_segs hls_inst/s_axi_BUS_A/Reg] SEG_hls_inst_Reg
