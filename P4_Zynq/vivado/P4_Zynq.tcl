...
#
# tutorialTeams.tcl: Tcl script for re-creating project 'tutorialTeams'
#
# Generated by Vivado on Wed Sep 01 14:52:38 -0500 2021
...
#
# 1. This project restoration tcl script (tutorialTeams.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Documentos/PVivado/tutorialTeams/tutorialTeams.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../PVivado/tutorialTeams"]"
...
#set_property -name "board_part_repo_paths" -value "C:/Users/Claudio/AppData/Roaming/Xilinx/Vivado/2019.1/xhub/board_store" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "ip_repo/ip_suma"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: suma_0, and set properties
  set suma_0 [ create_bd_cell -type ip -vlnv crzc:hls:suma:1.0 suma_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins suma_0/s_axi_BUS_A]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins suma_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins suma_0/ap_rst_n]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs suma_0/s_axi_BUS_A/Reg] SEG_suma_0_Reg
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1090 -y 260 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1090 -y 280 -defaultsOSRD
...
preplace inst suma_0 -pg 1 -lvl 3 -x 920 -y 140 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 10 450 250 760J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 20 430
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 240 770J
...
levelinfo -pg 1 0 230 610 920 1090
pagesize -pg 1 -db -bbox -sgen 0 0 1210 420
"
}
